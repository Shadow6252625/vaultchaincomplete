  ...
  return (
    <div className="min-h-screen antialiased text-zinc-100 font-sans selection:bg-blue-500/30 overflow-x-hidden relative">
      ...
      <main className="space-y-4 py-4">
        ...
        {/* 1. Hero Section */}
        <section className="px-6 overflow-hidden pt-4 pb-4 relative">
        ...
        <section id="capabilities" className="px-6 py-1">
        ...
        <section id="aura-emf5jfuh5" className="px-6 py-1">
        ...
        <section id="results" className="px-6 py-2">
